...
@section('content')
        ...
        <div class="card border-0 shadow mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between py-auto">
                    ...
                    <div class="btn btn-primary btn-sm px-4 border-0 shadow-sm" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">Add</div>
                    <!-- Modal -->
                            ...
                            <div class="modal-content">
                                ...
                                <form action="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        <div class="row btn-group p-3" role="group" id="package_list"
                                            aria-label="Basic radio toggle button group">
                                            @foreach ($packages as $package)
                                                <input type="radio" value="{{ $package['id'] }}" class="btn-check"
                                                    name="options" id="{{ $package['id'] }}"
                                                    onclick="chooseOption('{{ json_encode($package) }}')"
                                                    autocomplete="off">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary"
                                            onclick="openModal2()">lanjutkan</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        data-bs-target="#exampleModal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <table class="table">
                                        <tbody>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" onclick="closeModal2()"
                                        data-bs-dismiss="modal" data-bs-target="#exampleModal1">Close</button>
                                    <button type="button" class="btn btn-primary" id="order" onclick="orderNow()">Beli
                                        Sekarang</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn btn-sm btn-primary btn-icon shadow-sm"
                                            onclick="editModal('{{ json_encode($transaction) }}')">Detail</div>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                            ...
                            <div class="modal-body">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr id="buktiBayar">
                                            <td>Bukti Bayar</td>
                                            <td><button type="button" class="btn btn-info" id="buktiBayarDetail"
                                                    target="_blank" rel="noopener noreferrer"
                                                    onclick="getPaymentProof()"> Lihat Bukti Bayar </button></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div id="mustPayment">
                                    <label for="" class="form-label">Silahkan lakukan pembayaran pada no rekening
                                        berikut : </label>
    ...
    <script>
        url = "http://143.198.213.176/api/user/"
